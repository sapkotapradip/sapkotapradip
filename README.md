# Hi there
I am Pradip Sapkota, a third-year PhD student in the sorghum breeding lab, at Texas A&M University. My research focuses on strengthening predictive breeding strategies for grain composition traits and agronomic performance in grain sorghum hybrids. I am interested in testing a range of statistical approaches (non-linear and linear) in training models to predict economically important traits. In addition, I am interested in integrating a range of omics data (phenomics and enviromics) into genomic selection models to optimize model performance. My Ph.D. dissertation focuses on implementing omics-based predictive strategies to aid in the selection of improved traits in the range of germplasm. I find my passion in analyzing big data to discover patterns and implement those in real-world scenarios. All of my codes for performing analysis of multi-environment trials will be made available with publication. I am expecting to finish my PhD by mid-2025 and will be exploring opportunities in an industry with a focus on plant breeding, genomics, predictive breeding, and/or analytics. You can contact me at prdp@tamu.edu as well as at https://www.linkedin.com/in/sapkotapradip/ on Linkedin.
